...
export interface SubscriptionUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "PAUSER_ROLE"
...
export interface SubscriptionUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): SubscriptionUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: SubscriptionUpgradeableInterface;
