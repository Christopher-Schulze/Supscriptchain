...
/// @title Upgradeable version of Subscription.sol
/// @notice Uses OpenZeppelin upgradeable contracts so it can be deployed behind a proxy.
contract SubscriptionUpgradeable is Initializable, Ownable2StepUpgradeable, AccessControlUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /// @notice Initializer replacing the constructor for upgradeable contracts
    ...
    function subscribe(uint256 _planId) public whenNotPaused nonReentrant {
        ...
        SubscriptionPlan storage plan = plans[_planId];
        IERC20MetadataUpgradeable token = IERC20MetadataUpgradeable(plan.token);
